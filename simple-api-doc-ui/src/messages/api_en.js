...
api.label.groupName = 'Group Name'
...
api.label.duplicateStrategy = 'Duplicate Path'
api.label.selectFile = 'Select file'
api.label.importDuplicateStrategyAbort = 'Abort Import'
api.label.importDuplicateStrategySkip = 'Skip Duplicate Paths'
api.label.importDuplicateStrategyGenerate = 'Automatically Generate New Paths'
api.label.importTypeSimple = 'Current Simple Mock Service'
api.label.importTypeFastMock = 'Old FastMock Service (Test)'
api.label.importTypeSwagger = 'Swagger2/OpenAPI3.0 (Test)'
...
api.msg.importFileTitle = 'Import mock data'
api.msg.importFileLimit = 'File size limit is 5MB'
api.msg.importFileSuccess = 'Imported successfully, {0} group(s).'
