...
common.label.title = 'Simple API Doc'
...
common.label.saveAndClose = 'Save and Close'
common.label.close = 'Close'
common.label.copy = 'Copy'
common.label.copyOriginal = 'Copy Original'
common.label.copyModified = 'Copy Modified'
...
common.label.defaultTheme = 'Default Theme'
common.label.defaultShowLabel = 'Show Name/URL'
...
common.label.generateData = 'Generate data'
common.label.generateRequestData = 'Generate request data'
common.label.generateXmlData = 'Generate XML'
common.label.generateJsonData = 'Generate JSON'
common.label.generateAll = 'Generate all'
common.label.generateSelected = 'Generate selected'
common.label.codeEdit = 'Code Edit'
common.label.newWindowEdit = 'Edit in new window'
common.label.json = 'JSON'
common.label.yaml = 'YAML'
common.label.md = 'Markdown'
common.label.zip = 'Markdown ZIP'
common.label.selectAll = 'Select All'
common.label.onlySelected = 'Only Selected'
common.label.onlyApi = 'Only API'
common.label.onlyDoc = 'Only Doc'
common.label.selectedCount = 'Selected {0}/{1}'
common.label.selectedCountSimple = 'Selected {0}'
common.label.apiCount = 'API {0}'
common.label.docCount = 'Doc {0}'
...
common.label.commonGoto = 'Go to {0}'
...
common.msg.loginSubtitle = 'Efficient API documentation management, accelerate development.'
common.msg.loginWelcome = 'Welcome back! Please enter username and password.'
...
common.msg.commonClearConfirm = 'Confirm to clear [{0}]?'
common.msg.pleaseSelectReasonCode = 'Please select a reason code'
common.msg.noData = 'No Data'
common.msg.dataNotFound = 'Data not found'
...
common.msg.commonDuplicated = '{0} cannot be duplicated.'
common.msg.jsonError = 'Invalid JSON format.'
common.msg.unknownError = 'Unknown error'
common.msg.changePasswordTip = 'If you need to change the password, click to enable modification.'
