...
common.label.saveAndClose = '保存并关闭'
common.label.close = '关闭'
common.label.copy = '复制'
common.label.copyOriginal = '复制原内容'
common.label.copyModified = '复制修改的内容'
...
common.label.defaultTheme = '默认主题'
common.label.defaultShowLabel = '显示名称/URL'
...
common.label.generateData = '生成数据'
common.label.generateRequestData = '生成请求数据'
common.label.generateXmlData = '生成XML'
common.label.generateJsonData = '生成JSON'
common.label.generateAll = '所有接口生成'
common.label.generateSelected = '选中接口生成'
...
common.label.zip = 'Markdown 压缩包'
common.label.selectAll = '全选'
common.label.onlySelected = '仅看已选'
common.label.onlyApi = '仅接口'
common.label.onlyDoc = '仅文档'
common.label.selectedCount = '已选 {0}/{1} 项'
common.label.selectedCountSimple = '已选 {0}'
common.label.apiCount = '接口 {0}'
common.label.docCount = '文档 {0}'
...
common.msg.loginSubtitle = '高效API文档管理，加速开发流程。'
common.msg.loginWelcome = '欢迎回来！请输入用户名和密码。'
common.msg.loading = '系统加载中...'
...
common.msg.commonClearConfirm = '确定要清空【{0}】？'
common.msg.pleaseSelectReasonCode = '请选择一个原因代码'
common.msg.noData = '暂无数据'
common.msg.dataNotFound = '未找到相关数据'
...
common.msg.commonDuplicated = '{0}不能重复'
common.msg.jsonError = 'JSON格式不正确'
common.msg.unknownError = '未知错误'
common.msg.changePasswordTip = '如果需要修改密码，点击开启修改'
