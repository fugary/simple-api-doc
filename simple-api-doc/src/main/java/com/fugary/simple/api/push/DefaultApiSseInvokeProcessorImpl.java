...
@Slf4j
@Component
public class DefaultApiSseInvokeProcessorImpl implements ApiSseInvokeProcessor {
    ...
    @Override
    public SseEmitter processSseProxy(ApiParamsVo mockParams) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                // 准备请求头
                HttpHeaders headers = HttpRequestUtils.getHeaders(mockParams);
